  ...
  return (
    <Container visible={featured}>
      ...
      <ContainerData visible={featured}>
        ...
        <ContainerTwo>
          <Text1 Size={"8px"}>
            {address.length > 43 ? address.substring(0, 43) + "..." : address}
          </Text1>
          <Text2 disabledColor={true} Size={"7px"}>
            {country} / {city}
          </Text2>
        </ContainerTwo>
        <ContainerTwo row>
          <DimensionsContainer>
            <TfiRulerAlt2 fill="rgba(0, 0, 0, 0.5)" />{" "}
            <DimensionsText>{meters} m2.</DimensionsText>
          </DimensionsContainer>
          <DimensionsContainer>
            <BsDoorOpen fill="rgba(0, 0, 0, 0.5)" />{" "}
            <DimensionsText>{environments} amb.</DimensionsText>
          </DimensionsContainer>
          <DimensionsContainer>
            <MdOutlineSpaceDashboard fill="rgba(0, 0, 0, 0.5)" />{" "}
            <DimensionsText>{rooms} dorm.</DimensionsText>
          </DimensionsContainer>
          <DimensionsContainer>
            <MdOutlineBathtub fill="rgba(0, 0, 0, 0.5)" />{" "}
            <DimensionsText>{baths} baños.</DimensionsText>
          </DimensionsContainer>
        </ContainerTwo>
      </ContainerData>
      {viewDelete && (
