...
import { ListFilter, ItemFilter, ContainerListOfEstate } from './stylesFvorites';
import { MdSwapVert, MdSortByAlpha, MdArrowUpward, MdArrowDownward, MdCheckCircle } from "react-icons/md";
export const Favorites = () => {
    ...
    return (
        ...
        <Return title="Favoritas" viewTitle linke={-1}>
            <MdSwapVert size="25px" style={{background: 'transparent', position: 'relative', fill: onFilter ? '#D9D9D9' : '#000'}} 
        ...
        {onFilter &&<ListFilter>
            ...
            <ItemFilter onClick={()=>filterFavorites('ancient')}>
                <MdArrowDownward size="20px" style={{background: 'transparent'}}/>
